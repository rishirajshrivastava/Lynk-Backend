...
profileRouter.get("/profile/view", userAuth, async (req,res)=>{
    try{
        const USER_SAFE_DATA = "firstName lastName photoUrl age gender about skills height weight location occupation education smoking drinking exercise diet hasKids wantsKids about interests hobbies languages interestedIn relationshipStatus lookingFor bodyType ethnicity religion politicalViews _id";
